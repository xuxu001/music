# Generated by Django 2.1.7 on 2019-08-02 08:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_data', models.CharField(max_length=50, verbose_name='日期')),
            ],
            options={
                'verbose_name': '歌曲评论',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.index.Label', verbose_name='歌曲分类')),
            ],
            options={
                'verbose_name': '歌曲信息',
        ...
        migrations.AddField(
            model_name='dynamic',
            name='song',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.index.Song', verbose_name='歌名'),
        ),
        migrations.AddField(
            model_name='comment',
            name='song',
